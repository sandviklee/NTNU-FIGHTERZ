...
public class Vector {
     ...
     * @param vx         declares the x velocity
     * @param vy         declares the y velocity
     * @param ax         declares the x acceleration
     * @param ay         declares the y acceleration
     * @param direction  declares the direction of the vector, 1: right; -1:left
    ...
    /**
     * Subtracts the {@code Vector} to this Vector
     * @param vector Vector
     */
     ...
     * @param direction declares the direction of this vector
     */
    ...
    public void applyAcceleration(){
         ...
         * wasn't a factor of the velocity anymore.
         */
    ...
    /**
     * Validates the vector getting created
     * @param vx         declares the x velocity
     * @param vy         declares the y velocity
     * @param ax         declares the x acceleration
     * @param ay         declares the y acceleration
     */
    private void validateVector(double vx, double vy, double ax, double ay) {
        if (vx > 0 && ax > 0) {
            if (vx % ax != 0) {
