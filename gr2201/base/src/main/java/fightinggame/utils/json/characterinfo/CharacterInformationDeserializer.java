...
/**
 * CharacterInformationDeserializer is a JsonDeserializer for character
 * information.
 * The JSON it takes in follows the pattern described in the JSON schema in
 * docs/current/json/characterinfoformat.json
 */
public class CharacterInformationDeserializer extends JsonDeserializer<CharacterInformationObject> {
     ...
     */
    @Override
    public CharacterInformationObject deserialize(JsonParser p, DeserializationContext ctxt)
     ...
     * @return CharacterInformationObject containing containing one character's
     *         information
     * @throws IllegalArgumentException if JSON provides invalid data for
    ...
    public CharacterInformationObject deserialize(JsonNode jsonNode)
        ...
        if (jsonNode instanceof ObjectNode) {
            ...
            CharacterInformationObject character = new CharacterInformationObject(characterName, characterDescription,
