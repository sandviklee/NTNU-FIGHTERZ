...
/**
 * Contains all information relevant to display about a character on the
 * character information page.
 * Does not include detailed information about hitboxes and damage, only a
 * general description.
 */
public class CharacterInformationObject {
    ...
    /**
     * Constructs a CharacterInformationObject, does not check for incorrect input
     * as this might change and is done in the DAO.
     * 
     * @param name        the character name
     * @param description a general description about the character, their lore and
     *                    what they do
     * @param difficulty  an integer describing how difficult the character is to
     *                    play
     * @param playstyle   a word explaining the general playstyle/archetype this
    ...
    /**
     * @return HashMap containing special action name as key and special action
    ...
    /**
     * toString method for debugging purposes to easier read a
     * CharacterInformationObject
     * 
     * @return string containing all relevant information about a character's
     *         information page
     */
    @Override
