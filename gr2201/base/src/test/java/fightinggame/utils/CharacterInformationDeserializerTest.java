...
import fightinggame.utils.json.characterinfo.CharacterInformationDeserializer;

public class CharacterInformationDeserializerTest {
    private SimpleModule module = new SimpleModule("CharacterInformationDeserializer",
    ...
    private final String incorrectJsonNodes = "{\"characterDescription\":,\"difficulty\":,\"playstyle\":,\"specialActions\":[{\"specialActionName\":\"SpN1\",\"specialActionDescription\":\"SpD1\"},{\"specialActionName\":\"SpN2\",\"specialActionDescription\":\"SpD2\"},{\"specialActionName\":\"SpN3\",\"specialActionDescription\":\"SpD3\"},{\"specialActionName\":,\"specialActionDescription\":}]}";
    private final String incorrectJsonValues = "{\"characterName\":\"Char\",\"characterDescription\":\"Desc\",\"difficulty\":0,\"playstyle\":\"Style\",\"specialActions\":[{\"specialActionName\":\"SpN1\",\"specialActionDescription\":\"SpD1\"},{\"specialActionName\":\"SpN2\",\"specialActionDescription\":\"SpD2\"},{\"specialActionName\":\"SpN3\",\"specialActionDescription\":\"SpD3\"},{\"specialActionName\":\"SpN4\",\"specialActionDescription\":\"SpD4\"}]}";
    ...
    public void testDeserializeJSONString() throws IOException {
        ...
        assertEquals(4, character.getSpecialActions().size(),
                "Character does not have correct amount of special actions.");
        assertEquals("SpD1", character.getSpecialActions().get("SpN1"),
                "Special Action name does not match description.");
        assertEquals("Char\nDesc\n3\nStyle\nSpN4: SpD4\nSpN3: SpD3\nSpN2: SpD2\nSpN1: SpD1\n", character.toString());
        Assertions.assertThrows(JsonParseException.class, () -> {
            mapper.readValue(incorrectJsonNodes, typeRefSingle);
        }, "This CharacterInformationObject is not possible");

        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            mapper.readValue(incorrectJsonValues, typeRefSingle);
        }, "This CharacterInformationObject is not possible");
    }
    ...
    public void testExceptionsJSONString() throws IOException {
        ...
        // Test if deserializer throws error provided incorrect amount of special
        // actions
        try {
